...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "models.providers.*.quota": "Model Provider Cost Quota",
  "models.providers.*.quota.dailyCostUsd": "Daily Cost Limit (USD)",
  "models.providers.*.quota.monthlyCostUsd": "30-Day Cost Limit (USD)",
